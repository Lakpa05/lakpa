export default function About() {
    const tools = [
        { name: 'vscode', icon: '/assets/vscode.png', description: 'Vscode', },
    ...
    const data = [
        ...
        },
        {
            ...
            description: 'Bachelors in Computer Appliocation',
        },
        {
            name: 'Projects',
        ...
        <div id="about" className="w-full px-[12%] py-10 scroll-mt-20">
            ...
            <div className="flex w-full flex-col lg:flex-row items-center gap-20 my-20">
                <div className="max-w-max mx-auto relative">
                    <img src='/assets/user-image.png' alt="" className="w-64 sm:w-80  max-w-none rounded-full "/>
                ...
                <div className="w-full px-[12%] py-10 scroll-mt-20">
                    <p className="max-w-2xl mx-auto mt-5 mb-12 font-Ovo">I am an experienced Frontend Developer with over a decade of professional expertise in the field. Throughout my career, I have had the privilege of collaborating with prestigious organizations, contributing to their success and growth.</p>
                    ...
                    <div className="flex relative items-center gap-3 sm:gap-5">
                        {tools.map((tool) => (
                            <li
                            key={tool.name}
